...
- Risk: server compiler differs from local (package availability, encoding)
...
- Mitigation: categories reviewed in plan phase; verify arXiv category codes match paper content
